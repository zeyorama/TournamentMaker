<?php
  ...
  foreach (Game::getAllGamesArray() as $game) {
    if ($u->hasGame($game->getID())) continue;
    $games[$i++] = $game;
  }
...
<div class="span12 well">
  <li class="nav-header">Add game</li>
<?php
  if ($b) {
?>
  <form class="form-horizontal" action="action/user/addGame.php" method="GET">
...
<?php } else { ?>
  No additional Games to be added.
<?php } ?>
</div>